...
def detect_rte(tokenizer, model, dev_path, backdoored_dev_path, cleaned_dev_path):
...
def main():
    ...
    detect_rte(tokenizer, model,args.dev_path,args.out_backdoored_path,args.out_clean_path)
